2-MLO-LedTrafficSignal:
======================

This is a bare metal ARM assembly program to turn on all 4 usr leds one by one in a F1/grand-prix
race start signal pattern.
A slight improvement over the program in "1"
...
The MLO just acts as a container for bare metal assembly code.
...
7) You should see the leds come on one by one and go off and repeat the pattern.
